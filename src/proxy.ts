...
const PROTECTED_ROUTES = ["/dashboard", "/profile", "/applications", "/contractor-applications", "/protected"];
...
export async function proxy(request: NextRequest) {
    ...
    const isProtected = PROTECTED_ROUTES.some((r) => pathname.startsWith(r)) || isApplicantOnly || isContractorOnly || isSubcontractedApply;
