            ...
            >
                <Left class_name="max-[640px]:pt-[70px]">
                    <div className="flex flex-col justify-center">
                        <Banner_Title subtitle={content?.banner?.banner_label || "Subcontracted Project"} title={content?.banner?.banner_title || "Apply for Subcontracted Project"} />
                    </div>
                </Left>
                <Right>
                    <div></div>
                ...
                <div className="container !px-[50px] max-[1024px]:!px-4 pt-[80px] lg:pt-[150px] pb-[80px] lg:pb-[150px] border-x border-sah-light-3">
                    <div className="w-full bg-white lg:max-w-[750px] max-[640px]:px-4 p-10 flex flex-col rounded-[6px] overflow-hidden mx-auto">
                        <div className="bg-sah-red max-[640px]:-mx-4 -mx-10 -mt-10 px-4 xl:px-10 pt-[30px] xl:pt-[50px] pb-[30px] xl:pb-[50px] mb-8">
                            <p className="text-red-200 text-[13px] font-medium uppercase tracking-widest mb-1">{content?.form_title}</p>
                            <h2 className="text-[26px] sm:text-[36px] font-medium text-white leading-[36px] sm:leading-[46px]">{item.title}</h2>
