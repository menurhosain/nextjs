...
function StatusBadge({ label }: { label?: string }) {
    ...
    return <span className="inline-block text-xs font-medium bg-gray-100 text-gray-600 px-3 py-1 rounded-full capitalize">{label}</span>;
}
            ...
            <Banner bg="/home-hero.mp4" class_name="lg:min-h-[auto] xl:min-h-[auto] md:min-h-[auto] 2xl:h-[100vh] py-18 2xl:py-0 max-[640px]:pb-[65px]">
                <Left class_name="max-[640px]:pt-[70px]">
                    <div className="flex flex-col justify-center">
                        <Banner_Title subtitle="" title="Contractor Application" />
                    </div>
                </Left>
                <Right>
                    <div></div>
            ...
            <div className="min-h-screen bg-gray-50">
                <div className="max-w-2xl mx-auto px-6 py-10 space-y-6">
                    <div className="flex items-center gap-4">
                        <Link href="/dashboard" className="text-sm text-gray-500 hover:text-gray-900 underline underline-offset-2">
                            ← Dashboard
                        </Link>
                    </div>
