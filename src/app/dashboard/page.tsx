            ...
            <div className="min-h-screen bg-gray-50">
                <div className="max-w-4xl mx-auto px-6 py-10 space-y-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <a href="/subcontractors" className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <a href="/subcontractors" className="text-xs text-gray-500 hover:text-gray-900 underline underline-offset-2">
                                + New application
                            </a>
                        </div>
                        ...
                        {contractorApplications.length === 0 ? (
                            <div className="bg-white rounded-2xl border border-gray-100 p-8 text-center">
                                ...
                                <a href="/subcontractors" className="inline-block mt-3 text-sm font-medium text-gray-900 underline underline-offset-2">
