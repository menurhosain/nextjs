...
export async function reset_password(payload: { code: string; password: string; passwordConfirmation: string }) {
...
export async function verify_jwt(jwt: string): Promise<false | Record<string, unknown>> {
