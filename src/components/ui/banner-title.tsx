export default function Banner_Title({ subtitle, title }: { subtitle?: string; title: any }) {
    return (
        <>
            ...
            <h1 className="text-sah-white font-geist font-medium text-[32px] sm:text-[40px] xl:text-[56px] 2xl:text-[70px] leading-[1.3] xl:leading-[70px] 2xl:leading-[94px]">{title}</h1>
        </>
    );
}
