        ...
        <Link href={link}>
            <div className="bg-white group rounded-2xl p-5 flex flex-col gap-5 shadow-sm">
                ...
                <div className="flex items-start gap-5 min-h-[76px]">
                    ...
                    <span className="flex-shrink-0 self-end border border-sah-light-2 rounded-full px-[14px] py-[5px] font-inter text-[16px] font-medium text-[#111111] whitespace-nowrap">{scope}</span>
                </div>
