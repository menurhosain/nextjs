        ...
        <Link href={link}>
            <div className="bg-white group rounded-2xl p-5 flex flex-col gap-5 shadow-sm">
                ...
                <div className="min-h-[80px] relative">
                    <h3 className="font-geist text-[22px] xl:text-[26px] 2xl:text-[30px] group-hover:text-sah-red transition-colors duration-500 font-medium leading-[38px] text-sah-black">{title}</h3>
                ...
                <div className="relative rounded-xl overflow-hidden">
                    <img src={image} alt={title} className="w-full h-[340px] xl:h-[440px] object-cover group-hover:scale-110 transition-scale duration-500" />
