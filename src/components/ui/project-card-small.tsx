        ...
        <Link href={link}>
            <div className="bg-white group rounded-2xl p-3 sm:p-5 flex flex-col gap-5 shadow-sm">
                ...
                <div className="min-h-[80px] relative">
                    <h3 className="font-geist text-[18px] max-[640px]:leading-[24px] sm:text-[22px] xl:text-[26px] 2xl:text-[30px] group-hover:text-sah-red transition-colors duration-500 font-medium leading-[38px] text-sah-black max-[640px]:mb-2">{title}</h3>
                    <span className="border sm:absolute right-0 bottom-0 border-sah-light-2 rounded-full px-[14px] py-[5px] font-inter text-[16px] font-medium text-[#111111] whitespace-nowrap">
                        {scope[0]}
                    </span>
                </div>
                ...
                <div className="relative rounded-xl overflow-hidden">
                    ...
                    <div className="absolute bottom-4 right-4 bg-white rounded-xl px-[24px] py-[20px] max-[640px]:block grid grid-cols-[max-content_max-content] gap-x-[24px]">
