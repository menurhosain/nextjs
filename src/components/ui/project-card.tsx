...
export default function ProjectCard({ category, title, description, handover, location, image }: ProjectCardProps) {
    return (
        <div className="group flex border border-sah-light-3 rounded-sm overflow-hidden bg-sah-white">
            <div className="flex flex-col justify-between w-[30%] p-[36px] border-r border-sah-light-3 transition-colors duration-300 group-hover:bg-sah-red">
                ...
                <div className="flex gap-10">
                    <div className="flex flex-col gap-1 text-base font-inter font-medium leading-[24px]">
                        ...
                        <span className="text-sah-black transition-colors duration-300 group-hover:text-sah-white">{handover}</span>
                    </div>
                    <div className="flex flex-col gap-1 text-base font-inter font-medium leading-[24px]">
                        <span className="text-sah-gray-2 transition-colors duration-300 group-hover:text-sah-white/70">Location</span>
                        <span className="text-sah-black transition-colors duration-300 group-hover:text-sah-white">{location}</span>
                    </div>
                </div>
            </div>
