...
export default function Section_Title({
    ...
    return (
        <>
            ...
            <h2 className={`font-geist mb-[40px] font-medium text-[30px] sm:text-[40px] lg:text-[50px] xl:text-[80px] lg:leading-[60px] xl:leading-[90px] ${class_name.title}`}>{title}</h2>
