...
export default function Careers({ section_title, section_description, section_button_label, section_button_link, image_1, image_2, map_image, map_legend_1, map_legend_2 }: Props) {
            ...
            <section className="section-padding bg-sah-light-4">
                <div className="container !px-[50px] pt-[70px] lg:pt-[135px] pb-[63px] lg:pb-[140px] border-x border-sah-light-3 max-[1024px]:!px-4">
                    <div className="flex flex-col items-center">
                        <Section_Title
                            title={section_title || "Build your future through collaboration"}
                            description={section_description || "With us, your career is always moving forward. You’ll grow through continuous learning, guided by mentorship at every stage, while collaborating with diverse teams to broaden your skills, knowledge, and experience.Our leadership is rooted in strong values. Our culture reflects principles such as trust, openness, accountability, entrepreneurial spirit, integrity, and mutual respect—creating an environment where individuals and teams can truly thrive."}
                        ...
                        />
                        <a href={section_button_link || "#jobboard"} onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}
                        className={`
                        ...
                        `}
                        >
                        {section_button_label || "Start Your Career with Us"}
                        ...
                        <div className="w-full p-[0px] sm:p-[15px] xl:p-[24px] max-[640px]:border-0 border border-sah-light-3 rounded-[6px] mt-[60px] grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-[30px]">
                            <div className=" max-[768px]:order-2">
                                <img src={image_1 || "/careers-thumb-1.jpg"} alt="" className="!h-full !w-full object-cover object-center !relative rounded-[6px]" />
                            </div>
                                ...
                                <div className="mt-[30px] lg:mt-[55px] 2xl:mr-[50px] flex flex-col items-start gap-[12px] 2xl:pl-[120px] relative z-[5] ">
                                    <div className="flex items-start gap-2 md:max-w-[220px]">
                                        ...
                                        <p className="text-[14px] text-sah-gray-2 leading-[22px]">
                                            {map_legend_1 || "Location where Khabourah has done work"}
                                        </p>
                                    </div>
                                    <div className="flex items-start gap-2 md:max-w-[300px]">
                                        <span className="mt-1 w-3 h-3 bg-[#FA7575] flex-shrink-0" />
                                        <p className="text-[14px] text-sah-gray-2 leading-[22px] ">
                                            {map_legend_2 || "Location where Sabal Akhdar Police Station Complex"}
                                        </p>
                                    </div>
                                </div>
                                {/* Map */}
                                <div className="w-[52%] 2xl:w-full max-w-full mx-auto drop-shadow-lg mt-[20px] 2xl:mt-[-20px] relative z-[3]">
                                    <img src={map_image || "/careers-map-2.png"} alt="" className="!h-auto !w-auto !relative" />
                                </div>
                            </div>
                            <div className="max-[1280px]:col-span-2 max-[768px]:col-span-1">
                                <img src={image_2 || "/careers-thumb-2.jpg"} alt="" className="!h-full !w-full max-[1280px]:!h-[380px] max-[768px]:!h-full !relative rounded-[6px] object-cover object-center" />
                            </div>
                        </div>
                    </div>
                </div>
