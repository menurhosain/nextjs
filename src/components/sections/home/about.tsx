...
export default function About() {
    return (
        <section className="relative pt-27 pb-[140px] bg-sah-dark-2">
            <div className="container mx-auto">
                <div className="flex justify-space-between gap-[284px]">
                    <div className="basis-[27.4%] shrink-0">
                        <div className="text-white text-sm font-medium tracking-widest uppercase mb-9">[ About SAH ] ↓</div>
                    ...
                    <div>
                        <ScrollReveal toColor="var(--color-sah-white)">
                            <h2 className="text-[90px] leading-[90px] font-medium tracking-tight font-geist">
                                ...
                                <div className="text-sah-overlay-white-30 scroll-color">care, and engineering excellence</div>
                            </h2>
                        </ScrollReveal>
