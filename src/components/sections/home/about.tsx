                ...
                <div className="lg:flex justify-space-between 2xl:gap-[284px] xl:gap-[100px] gap-[50px]">
                    <div className="lg:basis-[340px] xl:basis-[432px] shrink-0 inline-block">
                        ...
                        <div className="relative rounded-[12px] overflow-hidden">
                            ...
                            <div className="absolute bottom-[12px] left-[12px] sm:w-[242px] w-[230px] rounded-[9px] p-2.5 text-[20px] sm:text-[24px] bg-sah-dark-1 text-sah-overlay-white-50 font-medium">
