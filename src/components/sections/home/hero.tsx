        ...
        <Banner bg="/home-hero.mp4">
            <Banner.Left class_name="">
                <div className="flex flex-col">
                    ...
                    <Link href="/register" className="inline-flex items-center gap-[10px] group bg-sah-red hover:bg-sah-white text-white hover:text-sah-red   text-[16px] font-bold px-[30px] py-[14px] rounded-[8px] w-fit transition">
                        You Like to Build?
            ...
            <Banner.Right>
                <div className="flex justify-start items-end h-full pt-[40px] sm:justify-end sm:pb-[100px] ">
