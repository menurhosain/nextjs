                    ...
                    <div className="grid grid-cols-7 gap-5 items-start">
                        ...
                        <div className="col-span-4">
                            ...
                            <div className="w-full mt-[60px]">
                                <div className="flex items-center gap-2 mb-0 pb-4 border-b border-sah-light-3">
                                ...
                                <div className="flex flex-col divide-y divide-sah-light-3">
                                    {benefits.map((item) => (
                    ...
                    <div className="grid grid-cols-7 gap-5 items-start">
                        ...
                        <div className="col-span-4">
                            <Section_Title
                                ...
                                class_name={
                                    {
                                        title: "xl:!text-[80px] xl:!leading-[86px] font-medium text-white !mb-[10px] max-w-[870px] text-[70px] ",
                                    }
                                }
                            />
                        </div>
